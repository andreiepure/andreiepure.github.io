...
1. Definition of a software supply chain

2. Overview of how NuGet works
* .NET dev platform = languages + libraries
* NuGet = the system to manage libraries in the ecosystem
* NuGet Package = compiled libraries + descriptive metadata (including version) + (eventually) target files that can execute arbitrary code
* Package Source (or feed) = a NuGet Server (can be public or private); a network location; a local folder
* Versions
  * fixed versions
  * version ranges
  * floating versions
* How the resolution works
  ...
  * if multiple sources contain the required version, the fastest call wins
* Images
  * "The flow of packages between creators, hosts, and consumers"
  * "Managing dependencies" 
   
3. High level explanation of the attack (10 minutes)
  * mention behavior for Python and NuGet
  
4. NuGet Demo (5 minutes)
...
7. How to protect your users (5 minutes)
...
Overview
https://docs.google.com/document/d/1BQtCADDv5wzmC1BZ53Tpot0p_ubgPIJRvk2BgTKq3Lo/edit#
